...
public class CardSlidePanel extends ViewGroup {
    ...
    // 超过这个值
    // 则下一层vicard_left_btnew完成向上一层view的过渡
    ...
    private BtnClickListener btnClickListener;  //下面两个按钮点击回调
            ...
            public void onClick(View view) {
                if (view.getId() == R.id.maskView) {
                    ...
                    if (view == leftBtn) {
                        ...
                        ///////////////////////////////////////////////////////////
                        btnClickListener.onClick(view, isShowing);
